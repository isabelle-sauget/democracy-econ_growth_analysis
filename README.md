...
* **Accurate Regime Clustering:** Using K-Means clustering, countries were organically categorized into 4 balanced groups that align with modern political regime classification: *Liberal Democracies, Electoral Democracies, Electoral Autocracies,* and *Closed Autocracies*. What's insightful is that countries were naturally grouped according to their true democratic (or lack thereof) values, such as for example Singapore, which is an autocracy that heavily practices media and opinion censorship and so very limited civil liberties for its citizens, has been grouped as a liberal democracy thanks to its almost zero corruption, good bureaucracy and its economic efficiency and infrastructure that provides a very high quality of life for the population. In such countries, the lack of political rights is compensated with the good quality of life, creating a cost of opportunity. Such autocratic countries seem to do better than some flawed democracies like Romania.
* **The Democratic Economic Dividend:** Correspondence analysis revealed a definitive geometric association between democracies and upper-middle to high-income categories.
* **The "Autocracy Trap":** 
